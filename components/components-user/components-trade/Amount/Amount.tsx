...
const Amount = () => {
  ...
  return (
    <div className="md:p-4 pb-8 p-2 flex flex-col gap-4">
      <h2 className="md:block hidden font-bold text-[20px]">Amount</h2>
      ...
      <div className="flex flex-col gap-2">
        <div className="flex justify-center items-center gap-2">
          <div className="p-2 rounded-lg bg-redColor text-white dark:bg-bgColorIcon cursor-pointer">
            <Minus />
          </div>
          <div className="flex rounded-lg justify-center items-center relative flex-grow py-2 bg-bgColorIconLight dark:bg-bgColorIcon">
            <p>0</p>
            <div className="absolute left-3 top-2 text-base font-medium">$</div>
          </div>
          <div className="p-2 rounded-md bg-greenColor text-white cursor-pointer">
            <Plus />
          </div>
        </div>
        <div className="md:flex hidden justify-center items-center w-full">
          <div className="flex flex-grow gap-2">
            <div className="flex-grow flex justify-center py-2 rounded-md bg-bgColorIconLight dark:bg-bgColorIcon dark:text-white cursor-pointer">
              +5
            </div>
            <div className="flex-grow flex justify-center py-2 rounded-md bg-bgColorIconLight dark:bg-bgColorIcon dark:text-white cursor-pointer">
              +10
      ...
      <div className="md:flex hidden justify-center items-center flex-col">
        ...
        <div className="font-bold text-[35px] text-greenColor">+$50.5</div>
      </div>
      <div className="flex flex-col gap-2">
        <h3 className="font-normal text-base md:block hidden">
          Traders sentiments
        </h3>
      ...
      <div className="flex justify-between items-center gap-3">
        <div className="flex-1">
          <Button className="bg-greenColor text-white w-full md:h-[50px] h-[44px] rounded-xl">
            <p className="font-bold uppercase text-[20px]">buy</p>
            <ArrowUpRight className="ml-2" size={30} />
          </Button>
        </div>
        <div className="flex-1">
          <div className="md:px-6 md:py-[2px] p-0 bg-bgColorIconLight dark:bg-bgColorIcon text-center rounded-xl">
        ...
        <div className="flex-1">
          <Button className="bg-redColor text-white w-full md:h-[50px] h-[44px] rounded-xl">
