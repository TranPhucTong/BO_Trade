...
const CustomSelectAcount: React.FC = () => {
  ...
  return (
    <div className="relative">
      <div
        className="md:w-[120px] md:h-[40px] w-[106px] h-[34px] border capitalize font-bold text-base leading-[20.42px] bg-white dark:bg-bgColorIcon border-none rounded-md flex justify-center items-center px-2 cursor-pointer"
        onClick={toggleDropdown}
      >
        {selectedOption ? (
          <div className="flex justify-center items-center md:gap-2 gap-1 w-full">
            <div className="flex flex-col">
              <h4 className="font-normal text-[8px] leading-[12.76px] text-textGray dark:text-text_2">
                {selectedOption.name}
              </h4>
              <p className="leading-[20.42px] text-sm font-bold">
