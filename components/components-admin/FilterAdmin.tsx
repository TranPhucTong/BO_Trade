...
const FilterAdmin = () => {
  ...
  return (
    <div className="flex md:flex-row md:px-0 px-4 flex-col w-full justify-between md:items-center gap-4 items-start">
      <select
        className="px-4 py-2 bg-white dark:bg-bgBoxDark dark:border-text_4 font-medium text-sm rounded-lg shadow-xl border border-text_2"
      ...
      <div className="flex flex-grow justify-between items-center md:gap-4 gap-2">
        <Input
          id="input-search"
